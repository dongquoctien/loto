...
@Component({
  ...
  styles: [`
    ...
    .sparkle-4 { bottom: 15%; right: 12%; animation-delay: 1.5s; }
    @keyframes sparkleBurst {
      0% { transform: scale(0); opacity: 1; box-shadow: 0 0 6px #FFD700, 0 0 12px #FFD700; }
      50% { transform: scale(2.5); opacity: 0.8; box-shadow: 0 0 12px #FFD700, 0 0 24px #FFA500; }
    ...
    @keyframes trophyGlow {
      ...
      50% { filter: drop-shadow(0 0 24px rgba(255, 215, 0, 0.9)) drop-shadow(0 0 40px rgba(255, 165, 0, 0.4)); }
    }
